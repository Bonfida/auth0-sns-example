...
export default function Home() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto py-10">
      <center>
        <Logo className="h-[96px]" alt="" variant="white" />
        <h1 className="mt-3 text-3xl font-medium text-center">
          Sign In With SNS
        </h1>
      </center>
      ...
      <center className="mt-5">
        <a href={user ? "/api/auth/logout" : "/api/auth/login"}>
          <button className="bg-indigo-600 rounded-md h-[56px] w-[300px] px-4 py-2">
            {user ? "Logout" : "Login"}
          </button>
        </a>
      </center>
